...
manipulador_arquivo = open('teste.txt', 'w')  # Abre o arquivo "teste.txt" em modo de escrita
manipulador_arquivo.write("escrevendo mais uma linha 1")  # Escreve uma linha no arquivo
manipulador_arquivo.close()  # Fecha o arquivo para salvar as alterações

manipulador_arquivo = open('teste.txt', 'a')  # Abre o arquivo "teste.txt" em modo de adição (append)
...
manipulador_arquivo.close()  # Fecha o arquivo
print("\n")

# Lendo arquivos
manipulador_arquivo = open('teste.txt', 'r')  # Abre o arquivo "teste.txt" em modo de leitura
print(manipulador_arquivo.read())  # Lê e imprime todo o conteúdo do arquivo
manipulador_arquivo.close()  # Fecha o arquivo após a leitura
print("\n")

# Imprimindo a primeira linha
manipulador_arquivo = open('teste.txt', 'r')  # Abre o arquivo "teste.txt" para leitura
...
manipulador_arquivo = open('teste.txt', 'r')  # Abre o arquivo para leitura
lixo = manipulador_arquivo.readline()  # Lê e descarta a primeira linha (não usaremos essa variável)
...
manipulador_arquivo = open("arquivo_pickle.txt", 'wb')  # Abre o arquivo em modo binário para escrita
...
manipulador_arquivo = open("arquivo_pickle.txt", 'rb')  # Abre o arquivo em modo binário para leitura
